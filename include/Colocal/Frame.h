...
std::vector<MapPoint *> GetMapPointMatches();
    ...
    //bitstream的frame
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, ORBextractor *extractorLeft, ORBextractor *extractorRight, ORBVocabulary *voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth);
    //压缩特征构建frame
