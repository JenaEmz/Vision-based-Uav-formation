...
//编队用control loop
void MavControlLoop::ControlLoopThread(Eigen::Vector3d &pos_sp, Eigen::Vector3d &pos, double yaw, double yaw_sp,Eigen::Vector3d &formation_offset)
{
    mavros_msgs::PositionTarget vel_msg{};
    ...
    ConstrainVector(vel_sp, 1.5,2);

    ConstrainVector(formation_offset,0.5,1);
    vel_sp = vel_sp +formation_offset;
